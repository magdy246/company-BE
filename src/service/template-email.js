export const html = async (otpCode) => {
    return `<!DOCTYPE html>
<html lang="en">
      ...
      ">
        <main>
          ...
          ">
              ...
              ">
                        Thank you for choosing Social-App. Use the following OTP
                        to complete the procedure to change your email address. OTP is
                        valid for
                        <span style="font-weight: 600; color: #1f1f1f;">10 minutes</span>.
                        Do not share this code with others, including Social-App
                        employees.
                    </p>
                    <p style="
               margin: 0 auto;
          ...
          ">
                Need help? Ask at
                <a href="mailto:social@gmail.com"
                    style="color: #499fb6; text-decoration: none;">social.app@gmail.com</a>
                or visit our
        ...
        ">
          ...
          ">
            ...
            <p style="margin: 0; margin-top: 16px; color: #434343;">
                Copyright © 2025 App. All rights reserved.
            </p>
        </footer>
    </div>
</body>
